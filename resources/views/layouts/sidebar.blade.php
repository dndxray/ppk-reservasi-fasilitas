<aside
    ...
    class="bg-[#3d1513] text-white flex-shrink-0 transition-all duration-200 overflow-y-auto"
>
    <div class="flex py-4 px-4" :class="sidebarOpen ? 'justify-end' : 'justify-center'">
    ...
    <nav class="py-2 space-y-1">
        ...
        <a href="{{ route('beranda') }}"
           class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
            ...
            <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Beranda</span>
        </a>
        ...
        @auth
            @if(Auth::user()->isPengguna())
                <a href="{{ route('fasilitas.index') }}"
                   class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
                    ...
                    <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Reservasi</span>
                </a>
                ...
                <a href="{{ route('reports.index') }}"
                   class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
                    ...
                    <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Laporan Saya</span>
                </a>
            @endif
            ...
            @if(Auth::user()->isPetugas())
                <a href="{{ route('petugas.reservations.queue') }}"
                   class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
                    ...
                    <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Antrian Reservasi</span>
                </a>
                ...
                <a href="{{ route('reports.antrian') }}"
                   class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
                    ...
                    <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Antrian Laporan</span>
                </a>
            @endif
            ...
            @if(Auth::user()->isAdmin())
                <a href="{{ route('admin.fasilitas.index') }}"
                   class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
                    ...
                    <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Kelola Fasilitas</span>
                </a>
                ...
                <a href="{{ route('admin.pengguna.index') }}"
                   class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
                    ...
                    <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Kelola Pengguna</span>
                </a>
                ...
                <a href="{{ route('admin.petugas.index') }}"
                   class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
                    ...
                    <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Kelola Petugas</span>
                </a>
                ...
                <a href="{{ route('admin.rekap.index') }}"
                   class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
                    ...
                    <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Rekap</span>
                </a>
            @endif
            ...
            <a href="{{ route('profile.edit') }}"
               class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
                ...
                <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Profil</span>
            </a>
        @else
            <a href="{{ route('login') }}"
               class="flex items-center gap-3 px-5 py-3 mx-2 rounded-lg transition
                ...
                <span x-show="sidebarOpen" x-transition class="text-sm font-medium whitespace-nowrap">Login</span>
            </a>
        @endauth
